...
<html lang="en">
   <head>
      ...
      <title>Laravel 11 Multi Auth::secretary</title>
   ...
   <body class="bg-light">
        <nav class="navbar navbar-expand-md bg-white shadow-lg bsb-navbar bsb-navbar-hover bsb-navbar-caret">
            <div class="container">
                <a class="navbar-brand" href="#">
                   <strong>Laravel 11 Multi Auth :: secretary</strong>
                </a>
        ...
        <div class="d-flex justify-content-center">
            <a class="btn bsb-btn-xl btn-primary py-3 " href="{{Route('secretary.addStudent')}}"> add Student</a>
        </div>

        <br>
        <br>
        <div class="d-flex justify-content-center">
            <a class="btn bsb-btn-xl btn-primary py-3 " href="{{Route('secretary.addSubject')}}"> add Subject</a>               
        </div>
        ...
        <br>
        <div class="d-flex justify-content-center">
            <a class="btn bsb-btn-xl btn-primary py-3 " href="{{Route('secretary.ShowConnectingTeacherWithSubject')}}"> Connecting the teacher with the Subject</a>               
        </div>
